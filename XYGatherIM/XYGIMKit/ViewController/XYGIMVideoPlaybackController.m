//
//  XYGIMVideoPlaybackController.m
//  XYGatherIM
//
...
static void *XYGIMVideoPlaybackRateObservationContext = &XYGIMVideoPlaybackRateObservationContext;
static void *XYGIMVideoPlaybackStatusObservationContext = &XYGIMVideoPlaybackStatusObservationContext;
static void *XYGIMVideoPlaybackCurrentItemObservationContext = &XYGIMVideoPlaybackCurrentItemObservationContext;

#define TOLERANCE_TIME_INTERVAL 1
@interface XYGIMVideoPlaybackController ()<UIGestureRecognizerDelegate>
...
@implementation XYGIMVideoPlaybackController{
    float minValue;
    float maxValue;
...
- (void)viewDidLoad {
    ...
    [_player addObserver:self
              forKeyPath:@"currentItem"
                 ...
                 context:XYGIMVideoPlaybackCurrentItemObservationContext];
    
    /* Observe the AVPlayer "rate" property to update the scrubber control. */
    [_player addObserver:self
              forKeyPath:@"rate"
                 options:NSKeyValueObservingOptionInitial | NSKeyValueObservingOptionNew
                 context:XYGIMVideoPlaybackRateObservationContext];
...
- (void)prepareToPlayAsset:(AVURLAsset *)asset withKeys:(NSArray *)requestedKeys {
    ...
    [playerItem addObserver:self
     ...
     NSKeyValueObservingOptionNew
                    context:XYGIMVideoPlaybackStatusObservationContext];
                       ...
                       context:(void*)context
{
    ...
    if (context == XYGIMVideoPlaybackStatusObservationContext)
    {
    ...
    else if (context == XYGIMVideoPlaybackRateObservationContext)
    {
    ...
    /* AVPlayer "currentItem" property observer.
     ...
     replacement will/did occur. */
    else if (context == XYGIMVideoPlaybackCurrentItemObservationContext)
    {
...
- (void)setPlaybackView:(XYGIMVideoPlaybackView *)playbackView {
...
- (void)playerPrepareToPlayFailed:(NSURL *)videoURL {
    ...
    [XYUtils showMessageAlertWithTitle:@"无法播放" message:@"无法播放视频,请稍后再试"];
