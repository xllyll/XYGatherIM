//
//  XYLocationSearchResultController.m
//  XYGatherIM
//
...
@interface XYLocationSearchResultController ()<UITableViewDataSource, UITableViewDelegate, AMapSearchDelegate>
...
@implementation XYLocationSearchResultController {
    NSInteger curPage;
...
- (void)viewDidLoad {
    ...
    CALayer *line1 = [XYUtils lineWithLength:SCREEN_WIDTH atPoint:CGPointZero];
...
- (void)setupFooterView {
    ...
    CALayer *line2 = [XYUtils lineWithLength:SCREEN_WIDTH atPoint:CGPointMake(0, CGRectGetHeight(_footerView.frame)-0.5)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!cell) {
        cell = [[XYLocationTableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:ID];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    XYLocationTableViewCell *cell = (XYLocationTableViewCell *)[tableView cellForRowAtIndexPath:indexPath];
