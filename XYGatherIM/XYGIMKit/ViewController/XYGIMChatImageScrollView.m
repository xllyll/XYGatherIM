...
@interface XYGIMChatImageScrollView()

@property (nonatomic) UIView *downloadFailedView;

@end

@implementation XYGIMChatImageScrollView
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    _messageBodyType = XYGIMMessageBodyTypeImage;
...
- (UIView *)downloadFailedView {
    if (!_downloadFailedView) {
        _downloadFailedView = [[NSBundle mainBundle] loadNibNamed:@"XYGIMImageDownloadFailView" owner:nil options:nil][0];
    }
