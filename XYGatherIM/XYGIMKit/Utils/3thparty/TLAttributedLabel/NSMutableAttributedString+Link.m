...
- (NSMutableArray *)setAttributedStringWithFont:(UIFont *)font
    ...
    NSArray *matches = [detector matchesInString:self.string
                                         options:0
    ...
    for (NSTextCheckingResult *result in matches)
    {
        ...
        if ([result resultType] == NSTextCheckingTypePhoneNumber){
            ...
            TLAttributedLink *linkData = [[TLAttributedLink alloc] init];
            linkData.title = txt;
            linkData.isPhone = YES;
            linkData.showUrl = nil;
            linkData.url = nil;
            linkData.showUrl = nil;
            linkData.showUrl = YES;
            [links addObject:linkData];
