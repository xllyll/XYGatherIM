...
@interface XYPopOverRootViewController : UIViewController
...
@implementation XYPopOverRootViewController
...
@implementation XYUtils (Application)
...
+ (UIWindow *)popOverWindow {
    ...
    dispatch_once(&onceToken, ^{
        ...
        popOverWindow.rootViewController = [[XYPopOverRootViewController alloc] initWithNibName:nil bundle:nil];
    });
...
+ (void)addViewToPopOverWindow:(UIView *)view {
    XYPopOverRootViewController *vc = (XYPopOverRootViewController *)[XYUtils popOverWindow].rootViewController;
    ...
    [XYUtils popOverWindow].hidden = NO;
...
+ (void)removeViewFromPopOverWindow:(UIView *)view {
    ...
    if (vc.view.subviews.count == 0) {
        [XYUtils popOverWindow].hidden = YES;
    }
}
